...
define(['dojo/_base/connect', 'dojo/_base/declare', 'light/utils/URLUtils',
        'dojo', 'light/enums/EventsEnum', 'light/RegexCommon',
        'light/builders/SearchStateBuilder'],
        function(connect, declare, URLUtils, dojo,
                 EventsEnum, RegexCommon, SearchStateBuilder) {

  /** @exports SearchRouter as light.routers.SearchRouter */
  var SearchRouter = declare('light.routers.SearchRouter', null, {
    /** @lends light.routers.SearchRouter# */
   ...
   * {@link light.routers.SearchRouter.searchStateToHash} throwing
