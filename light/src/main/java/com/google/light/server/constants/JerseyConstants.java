...
public class JerseyConstants {
  ...
  public static final String PATH_MODULE_VERSION_CONTENT = PATH_MODULE_VERSION + "/" + CONSTANT_CONTENT;
  public static final String PATH_MODULE_RESOURCE = PATH_MODULE_VERSION + "/" + PATH_RESOURCE_TYPE + "/" + PATH_RESOURCE;
