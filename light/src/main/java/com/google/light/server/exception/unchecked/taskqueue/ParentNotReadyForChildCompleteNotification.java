...
public class ParentNotReadyForChildCompleteNotification extends PipelineIgnoreException {
   ...
   * {@inheritDoc}
   */
  public ParentNotReadyForChildCompleteNotification() {
      super();
  }
   ...
   * @param message
   */
  public ParentNotReadyForChildCompleteNotification(String message) {
      super(message);
  }
   ...
   * {@inheritDoc}
   */
  public ParentNotReadyForChildCompleteNotification(String message, Throwable cause) {
      super(message, cause);
  }
   ...
   * {@inheritDoc}
   */
  public ParentNotReadyForChildCompleteNotification(Throwable cause) {
      super(cause);
  }
}
