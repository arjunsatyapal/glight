...
public class TestResources extends AbstractJerseyResource {
  ...
  public Response getTestLinks() {
    try {
      StringBuilder builder = new StringBuilder();
      appendSectionHeader(builder, "General User Utilities");
      ...
      appendHref(builder, JerseyConstants.URI_JOB_DETAIL, "Specific Job");
      ...
      appendHref(builder, JerseyConstants.URI_TEST_ADMIN_DELETE_ALL, "DeleteAll");
      appendHref(builder, JerseyConstants.URI_TEST_ADMIN_PURGE_QUEUES, "PurgeQueues");
      appendHref(builder, JerseyConstants.URI_SEARCH_INDEX_UPDATE_INDICES, "Update Search Indices");

      appendSectionHeader(builder, "Cron");
      appendHref(builder, JerseyConstants.URI_CRON_SEARCH_INDEX_REFRESH,
          "Cron : Update Search Index");
