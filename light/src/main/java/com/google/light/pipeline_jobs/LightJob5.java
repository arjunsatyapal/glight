...
public abstract class LightJob5<T, T2, T3, T4, T5> extends Job5<T, LightJobContextPojo, T2, T3, T4, T5> implements
    BasicJobMethods {
  ...
  @Override
  public Value<T> run(LightJobContextPojo context, T2 param2, T3 param3, T4 param4, T5 param5) {
    this.context = checkNotNull(context);

    bootStrapGuice();

    return handler(param2, param3, param4, param5);
  }
   ...
   * @return
   */
  public abstract Value<T> handler(T2 param2, T3 param3, T4 param4, T5 param5);
}
