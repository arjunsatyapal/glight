...
/**
 * Test for {@link ModuleId}
 *
 * @author Arjun Satyapal
 */
public class ModuleIdTest implements AbstractTypeWrapperTest {
  private Long longNumber = new Long(4567890L);
  private ModuleId wrapperObject = new ModuleId(longNumber);
  ...
  public void test_toString() {
    assertEquals("ModuleId:" + longNumber, wrapperObject.toString());
  }
  ...
  public void test_toXml() throws Exception {
    String expectedXml = getResourceAsString(TestResourcePaths.MODULE_ID_XML.get());
    assertEquals(expectedXml, XmlUtils.toXml(wrapperObject, ModuleId.class));
  }
  ...
  public void test_fromXml() {
    String expectedXml = getResourceAsString(TestResourcePaths.MODULE_ID_XML.get());
    ModuleId temp = XmlUtils.getPojo(expectedXml, ModuleId.class);
  ...
  public void test_fromJson() {
    assertEquals(wrapperObject, JsonUtils.getPojo(expectedJson, ModuleId.class));
  }
  ...
  public void test_constructor() {
    assertEquals(wrapperObject, new ModuleId(longNumber));
  ...
  public void test_constructor_string() {
    assertEquals(wrapperObject, new ModuleId(Long.toString(longNumber)));
  }
}
