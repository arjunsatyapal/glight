...
/**
 * Test for {@link CollectionId}
 *
 * @author Arjun Satyapal
 */
public class CollectionIdTest implements AbstractTypeWrapperTest {
  private Long longNumber = new Long(234567890L);
  private CollectionId wrapperObject = new CollectionId(longNumber);
  ...
  public void test_toString() {
    assertEquals("CollectionId:" + longNumber, wrapperObject.toString());
  }
  ...
  public void test_toXml() throws Exception {
    String expectedXml = getResourceAsString(TestResourcePaths.COLLECTION_ID_XML.get());
    assertEquals(expectedXml, XmlUtils.toXml(wrapperObject, CollectionId.class));
  }
  ...
  public void test_fromXml() {
    String expectedXml = getResourceAsString(TestResourcePaths.COLLECTION_ID_XML.get());
    CollectionId temp = XmlUtils.getPojo(expectedXml, CollectionId.class);
  ...
  public void test_fromJson() {
    assertEquals(wrapperObject, JsonUtils.getPojo(expectedJson, CollectionId.class));
  }
  ...
  public void test_constructor() {
    assertEquals(wrapperObject, new CollectionId(longNumber));
  ...
  public void test_constructor_string() {
    assertEquals(wrapperObject, new CollectionId(Long.toString(longNumber)));
  }
}
